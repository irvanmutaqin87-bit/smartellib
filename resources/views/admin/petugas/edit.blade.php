...
@section('title', 'Edit Petugas - SMARTELLIB')

@section('header')
<span class="text-2xl font-semibold">Edit Petugas</span>
@endsection
...
<div class="relative max-w-5xl mx-auto">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 relative overflow-visible">
        ...
        <form id="petugasForm" action="{{ route('admin.petugas.update', $petugas->id) }}" method="POST" class="space-y-8">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="nama" value="{{ old('nama', $petugas->user->nama) }}"
                           class="w-full rounded-xl border border-slate-200 px-4 py-3 text-sm text-slate-700 focus:border-cyan-700 focus:ring-cyan-700">
                    @error('nama')
              ...
              <div class="relative z-40">
                  ...
                  <div class="relative">
                      ...
                      <input type="hidden" name="status" id="petugasStatusInput" value="{{ old('status', $petugas->user->status) }}">
                  </div>
