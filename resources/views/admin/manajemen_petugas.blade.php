...
@section('title', 'Manajemen Petugas Admin - SMARTELLIB')

@section('header')
<span class="text-2xl font-semibold">Manajemen Petugas</span>
@endsection
...
<div class="flex flex-wrap items-center gap-3 mb-5">
    ...
    <!-- Spacer biar filter + button ke kanan -->
    <div class="ml-auto flex items-center gap-3">
        ...
        <div class="relative">
            ...
            <div id="statusFilterDropdown"
                ...
                <button type="button" class="statusOption w-full text-left px-4 py-2.5 rounded-xl hover:bg-slate-100 text-sm text-slate-700 transition">Aktif</button>
                <button type="button" class="statusOption w-full text-left px-4 py-2.5 rounded-xl hover:bg-slate-100 text-sm text-slate-700 transition">Nonaktif</button>
            </div>
        </div>

        <!-- Button Tambah -->
        <button onclick="openAddModal()"
            class="flex items-center gap-2 text-white px-5 py-2.5 rounded-xl text-sm font-semibold shadow bg-cyan-900/80 hover:bg-cyan-800/80 transition-colors">
            Tambah Petugas
        </button>
    </div>
</div>
    ...
    <table class="w-full text-sm">
        <thead>
            <tr class="bg-slate-50 border-b border-slate-200">
                ...
                <th class="text-left px-5 py-3.5 font-semibold text-slate-400 text-xs uppercase tracking-wider">Nama Petugas</th>
        ...
        <tbody id="staffTableBody">
            ...
            <tr class="border-b border-slate-100 hover:bg-slate-50 transition">
                ...
                <td class="px-5 py-4 font-medium text-slate-800">Irvan Mutaqin</td>
                <td class="px-5 py-4 text-slate-600">irvan@gmail.com</td>
                <td class="px-5 py-4">
                ...
                <td class="px-5 py-4 text-center">
                    <div class="relative inline-block">
                      ...
                      <div class="bookActionDropdown absolute right-full top-1/2 -translate-y-1/2 mr-3 w-52 bg-white rounded-2xl shadow-xl border border-slate-200 p-2 z-50
                          ...
                          <a href="#" class="flex items-center gap-3 px-4 py-3 rounded-xl text-sm text-slate-700 hover:bg-slate-50 transition">
                              Detail Petugas
                          </a>
            ...
            <tr class="border-b border-slate-100 hover:bg-slate-50 transition">
                ...
                <td class="px-5 py-4 font-medium text-slate-800">Aisyah Putri</td>
                <td class="px-5 py-4 text-slate-600">aisyah@gmail.com</td>
                <td class="px-5 py-4">
