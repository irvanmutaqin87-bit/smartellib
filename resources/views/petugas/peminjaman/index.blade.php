...
@section('title', 'Manajemen Peminjaman Petugas - SMARTELLIB')

@section('header')
<span class="text-2xl font-semibold">Manajemen Peminjaman</span>
@endsection
        ...
        <table class="w-full text-sm">
            <thead>
                <tr class="bg-slate-50 border-b border-slate-200">
                    ...
                    <th class="text-left px-5 py-3.5 font-semibold text-slate-400 text-xs uppercase tracking-wider">Tanggal Pinjam</th>
            ...
            <tbody id="tableContainer">
                @include('petugas.peminjaman.partials.table', ['data' => $data])
            </tbody>
        </table>
