...
@section('title', 'Manajemen Antrian Peminjaman Petugas - SMARTELLIB')

@section('header')
<span class="text-2xl font-semibold">Manajemen Antrian Peminjaman</span>
@endsection
    ...
    <div class="flex flex-wrap items-center gap-3 mb-5">
        ...
        <div class="relative">
            ...
            <div id="statusFilterDropdown"
                ...
                <button type="button" class="statusOption w-full text-left px-4 py-2.5 rounded-xl hover:bg-slate-100 text-sm text-slate-700 transition" data-value="menunggu">
                    Menunggu
                </button>
                <button type="button" class="statusOption w-full text-left px-4 py-2.5 rounded-xl hover:bg-slate-100 text-sm text-slate-700 transition" data-value="diproses">
                    Diproses
                </button>
                <button type="button" class="statusOption w-full text-left px-4 py-2.5 rounded-xl hover:bg-slate-100 text-sm text-slate-700 transition" data-value="selesai">
                    Selesai
                </button>
                <button type="button" class="statusOption w-full text-left px-4 py-2.5 rounded-xl hover:bg-slate-100 text-sm text-slate-700 transition" data-value="dibatalkan">
                    Dibatalkan
                </button>
            </div>
        </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-visible relative">
        ...
        <table class="w-full text-sm">
            ...
            <tbody id="tableContainer">
                @include('petugas.antrian.partials.table', ['data' => $data])
            </tbody>
        </table>
