        ...
        <div class="flex flex-col xl:flex-row gap-6 items-stretch">
            ...
            <div class="w-full xl:w-[65%] bg-white rounded-2xl border border-slate-200 shadow-sm overflow-visible">
                ...
                <div class="p-6 space-y-5">
                    ...
                    @php
                        function inputRow($label, $value, $type = 'text') {
                            return "
                            <div class='flex flex-col md:flex-row md:items-center gap-2 md:gap-4'>
                                ...
                                <input type='$type' value='$value'
                                    class='flex-1 border border-slate-200 rounded-xl px-4 py-2.5 text-sm text-slate-700 bg-white hover:border-cyan-700 outline-none transition-all'/>
                            </div>";
                        }
                    @endphp
                    ...
                    {!! inputRow('Judul Buku', 'Atomic Habits') !!}
                    {!! inputRow('Kode Buku', 'BK001') !!}
                    {!! inputRow('Penulis', 'James Clear') !!}
                    {!! inputRow('Penerbit', 'Gramedia Pustaka Utama') !!}
                    {!! inputRow('Tahun Terbit', '2019', 'number') !!}
                    {!! inputRow('Total Halaman', '312', 'number') !!}
                    ...
                    <div class="flex flex-col md:flex-row md:items-start gap-2 md:gap-4 relative z-50">
                        ...
                        <div class="flex-1 relative">
                            <button type="button" id="kategoriFilterBtn"
                                ...
                                <span id="kategoriFilterText">Self Development</span>
                            ...
                            <!-- Hidden input -->
                            <input type="hidden" name="kategori" id="kategoriInput" value="Self Development">
                        </div>
                    </div>

                    {!! inputRow('Stok Total', '12', 'number') !!}
            ...
            <div class="w-full xl:w-[35%] flex flex-col gap-6">
                ...
                <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden flex flex-col flex-1 min-h-[420px]">
                    ...
                    <div class="p-5 flex-1 flex">
                        <textarea
                            class="w-full h-full min-h-[300px] border border-slate-200 rounded-xl px-4 py-3 text-sm text-slate-700 resize-none bg-white hover:border-cyan-700 outline-none transition-all">Atomic Habits karya James Clear membahas bagaimana perubahan kecil yang dilakukan secara konsisten dapat memberikan hasil besar dalam jangka panjang.</textarea>
                    </div>
                </div>
