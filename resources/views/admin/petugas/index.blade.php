...
<div class="relative">
    ...
    <div class="flex flex-wrap items-center gap-3 mb-5">
        ...
        <a href="{{ route('admin.petugas.create') }}"
            class="px-4 py-2.5 bg-cyan-900 text-white rounded-xl text-sm font-medium hover:bg-cyan-800 transition shadow-sm">
            Tambah Petugas
        </a>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-visible">
        ...
        <table class="w-full text-sm">
            <thead>
                <tr class="bg-slate-50 border-b border-slate-200">
                    ...
                    <th class="text-left px-5 py-3.5 font-semibold text-slate-400 text-xs uppercase tracking-wider">No HP</th>
        ...
        <div id="paginationContainer">
            @include('components.pagination', ['paginator' => $petugas])
        </div>
    </div>
</div>
@endsection